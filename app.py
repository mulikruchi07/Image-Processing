...
#today our country is self reliant as far as the prouction of food grain in consern we are able to export the surplus grains the tremendeous increase in*/
@app.route('/')
def index():
